class Counter:
    ...
    def get_data(self):
        ...
        for value in self.input:
            self.result += value
            if self.result not in self.array:
