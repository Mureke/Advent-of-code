...
// fn count_fish(mut values: Vec<i32>, days: i32) -> usize {
//     for i in 0..days {
...
fn count_fish(mut values: Vec<i32>, days: i32) -> i64 {
...
pub fn solve() {
    ...
    let mut res1 = count_fish(values.clone(), 80);
    let mut res2 = count_fish(values.clone(), 256);
