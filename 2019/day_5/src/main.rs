        ...
        'inner1: loop {
            ...
            'inner2: loop {
                match values[i] {
                    ...
                    3 => { values = handle(values, i, 3) }
                    4 => { values = handle(values, i, 4) }
                    99 => { break 'inner2; }
                    _ => println!("error!")
                }
                i += 4;
