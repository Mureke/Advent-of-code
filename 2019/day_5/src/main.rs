    ...
    'outer: loop {
        ...
        'inner1: loop {
            ...
            'inner2: loop {
                ...
                let mut instruction = &instruction_vector[4] + instruction_vector[5];
                let mut modes: Vec<i32> = Vec::from_iter(instruction_vector[1..4].iter().cloned());
